                ...
                <div className=' '>
                        ...
                        {users.length > 0 && (
                            ...
                            {users.map(user => (
                                <Link to='Home'>
                                <li 
                                    className="card2  font-Sora text-center  " key={user.id}> 
                                    <img className=" card   "  src={`https://www.artic.edu/iiif/2/${user?.image_id}/full/330,/0/default.jpg`}  />
                                    <div className="text-[24px] pt-10">{user.title} </div> 
                                    <div className=" pt-8 ">{user.updated_at}</div>
                                 </li>
                                 </Link>
                            ))}
                            </ul>
